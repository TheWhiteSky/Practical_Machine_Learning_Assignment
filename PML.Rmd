...
# Coursera Practical Machine Learning Assignment: Write-up
## Assignment
In this assignment we are going to develop a machine learning model to predict the type of exercise performed based on different types of measurements given. We are given two files: **training** and **testing**. The first file is the training file, used to develop our algorithm, and the second is used to make our final predictions.
...
dim(c)
```
After applying the NA removal, we now have 19622 observations and 53 predictions
...
after the data is processed, we analyse it using previous model developed
```{r}
